...
Blockly.Blocks.fable_lists_sublist = {
  /**
   * Block for getting sublist.
   * @this {Blockly.Block}
   */
  init: function() {
    this['WHERE_OPTIONS_1'] =
        [
          [Blockly.Msg['FABLE_LISTS_GET_SUBLIST_START_FROM_START'], 'FROM_START'],
          [Blockly.Msg['FABLE_LISTS_GET_SUBLIST_START_FROM_END'], 'FROM_END'],
          [Blockly.Msg['FABLE_LISTS_GET_SUBLIST_START_FIRST'], 'FIRST']
        ];
    this['WHERE_OPTIONS_2'] =
        [
          [Blockly.Msg['LISTS_GET_SUBLIST_END_FROM_START'], 'FROM_START'],
    ...
    this['ACTION'] = [
      [Blockly.Msg['FABLE_LISTS_SUBLIST_GET'], 'GET'],
      [Blockly.Msg['FABLE_LISTS_SUBLIST_GET_REMOVE'], 'GET_REMOVE'],
      [Blockly.Msg['FABLE_LISTS_SUBLIST_REMOVE'], 'REMOVE']
    ];

    this.appendDummyInput().appendField(new Blockly.FieldDropdown(this['ACTION']), 'ACTION');
  ...
  ensureSearchKeywords: function() {
    ...
    Blockly.Search.preprocessSearchKeywords("fable_lists_sublist", keywords, toolboxKeywords);
  },
  /**
   * Create XML to represent whether there are 'AT' inputs.
   * @return {Element} XML storage element.
